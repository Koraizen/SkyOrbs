...
import com.skyorbs.shapes.impl.SphereShape;
import com.skyorbs.shapes.impl.EllipsoidShape;
...
public class SatelliteGenerator {
    ...
    public List<Orb> generateSatellitesForPlanet(Orb planet, World world) {
        ...
        int minCount = 0;
        int maxCount = 3;
        int count = minCount + random.nextInt(maxCount + 1);
        ...
        for (int i = 0; i < count; i++) {
            ...
            PlanetShape shape = random.nextBoolean() ? new SphereShape() : new EllipsoidShape();
